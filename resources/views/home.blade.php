    ...
    <div class="pt-3">
        <div class="row">
            ...
            <div class="col-6 mt-30" id="poiContent">
                ...
                <div class="next-slide"><i class="fa fa-arrow-circle-up" aria-hidden="true" style="font-size: 40px;"></i></div>
                <div class="prev-slide"><i class="fa fa-arrow-circle-down" aria-hidden="true" style="font-size: 40px;"></i></div>
